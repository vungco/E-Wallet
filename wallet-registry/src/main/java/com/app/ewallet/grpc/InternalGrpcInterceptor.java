...
/**
 * Kiểm tra {@code x-internal-api-key} (khi bật) và bắt buộc {@code idempotency-key} trên mọi RPC ledger.
 */
@Component
...
public class InternalGrpcInterceptor implements ServerInterceptor {
    ...
    public <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(
        ...
        Context ctx = Context.current().withValue(LedgerGrpcContext.IDEMPOTENCY_KEY, idempotency.trim());
